...
/*
 * @NAME: list_size
 * @DESC: Retorna el tamanio de la lista
 */
 ...
 * @DESC: Cuenta la cantidad de elementos de la lista que cumplen una condicion
 */
 ...
 * @DESC: Determina si algun elemento de la lista cumple una condicion
 */
...
/*
 * @NAME: list_any_satisfy
 * @DESC: Determina si todos los elementos de la lista cumplen una condicion
 */
